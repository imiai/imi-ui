...
var Select = function (props) {
    var options = props.options, renderOption = props.renderOption, rest = __rest(props, ["options", "renderOption"]);
    ...
    return (React.createElement("div", { className: "imiui-select", ref: ref, onClick: function () { return setShowOptions(true); } },
        ...
        showOptions && React.createElement(Card, { className: "options", variant: 'dialogue' }, options.map(function (option, index) {
            return (React.createElement("button", { key: index, onClick: function (event) { return onInputChange(event, option.value); }, className: 't-label-regular-tiny' }, renderOption(option)));
        }))));
};
