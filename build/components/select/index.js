...
var Select = function (props) {
    var options = props.options, className = props.className, _a = props.inputClassName, inputClassName = _a === void 0 ? '' : _a; props.label; var withLabel = props.withLabel, rest = __rest(props, ["options", "className", "inputClassName", "label", "withLabel"]);
    ...
    return (React.createElement("div", { className: "imiui-select".concat(className ? " ".concat(className) : ''), ref: ref, onClick: function () { return setShowOptions(!showOptions); } },
        ...
        showOptions && React.createElement(Card, { ref: optionsRef, id: 'imiui-select-options-id', style: __assign({}, optionsPosition), className: "options", variant: 'dialogue' }, options.map(function (option, index) {
            return (React.createElement("button", { key: index, onClick: function (event) { return onInputChange(event, option); }, className: "t-label-regular-tiny ".concat(option.label === rest.value ? 'active' : '') },
