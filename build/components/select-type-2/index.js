...
var SelectType2 = function (props) {
    ...
    return (React.createElement("div", { className: "imiui-select-t2".concat(className ? " ".concat(className) : ''), ref: ref, onClick: function () { return setShowOptions(!showOptions); } },
        React.createElement(Input, __assign({}, rest, { value: (selectingOption === null || selectingOption === void 0 ? void 0 : selectingOption.label) || '', inputClassName: inputClassName, disabled: true, readOnly: true, withLabel: withLabel })),
        React.createElement("div", { className: "select-line" },
            React.createElement("p", { className: "t-label-semibold-tiny c-primary-blue" }, (selectingOption === null || selectingOption === void 0 ? void 0 : selectingOption.label) || ''),
            React.createElement(ArrowDownIcon, { width: 20, height: 20, fill: "var(--imiui-gray-200)" })),
