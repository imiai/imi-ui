...
var Chip = function (props) {
    var _a = props.size, size = _a === void 0 ? 32 : _a, content = props.content, _b = props.isSelected, isSelected = _b === void 0 ? false : _b, onClose = props.onClose, iconLeft = props.iconLeft, className = props.className, _c = props.textClassName, textClassName = _c === void 0 ? 't-body-regular-small' : _c, rest = __rest(props, ["size", "content", "isSelected", "onClose", "iconLeft", "className", "textClassName"]);
    if (onClose) {
        return (React.createElement("div", { className: "imiui-chip size_".concat(size, " ").concat(isSelected ? 'selected' : 'unselected', " ").concat(className) },
            ...
            React.createElement("p", { className: textClassName }, content),
            onClose &&
