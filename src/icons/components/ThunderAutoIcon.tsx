...
const ThunderAutoIcon = (props: IIconsProps) => {
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" fill={fill} className={className} xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M16 2H8.10007C6.83855 2 5.71306 2.7892 5.28195 3.97477L2.48795 11.6583C2.2508 12.3104 2.73378 13 3.42775 13H6.00005L4.50005 22L18 8H12L16 2ZM13.2931 10H8.26302L12.263 4H8.10007C7.68054 4 7.30558 4.26215 7.16154 4.65826L4.85545 11H8.36097L7.53187 15.9746L13.2931 10Z" />
